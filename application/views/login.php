        ...
        <div class="card card-primary card-authentication1 mx-auto my-5 animated bounceInDown">
            <div class="card-body">
                <div class="card-content p-2">
                    <div class="card-title text-uppercase text-center pb-2"><?php echo $this->lang->line('login'); ?>
                    </div>
                   
                        <div class="col-md-12 col-sm-12 col-xs-12 text-center">
                            <p class="red" style="color: #fff;"><?php echo $this->session->flashdata('error'); ?></p>
                            <p class="green" style="color: #fff;"><?php echo $this->session->flashdata('success'); ?>
                            </p>
                        </div>
            ...
            <div class="col-md-12 col-sm-6 col-xs-12">
                <input class="btn btn-primary shadow-primary btn-block waves-effect waves-light" type="submit"
                    name="submit" value="<?php echo $this->lang->line('login'); ?>" />
    </div>
 
            <hr>
           <p class="text-muted"> <a href="<?php echo site_url('forgot') ?>"><?php echo $this->lang->line('lost_your_password'); ?></a></p>
        </div>

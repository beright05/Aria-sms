...
<div class="item form-group">
    <label class="control-label col-md-10 col-sm-10 col-xs-12" for="school_id"><?php echo $this->lang->line('school_name'); ?> <span class="required">*</span></label>
    <div class="col-md-6 col-sm-6 col-xs-12">
        <select  class="form-control single-select fn_school_id" name="school_id" id="add_school_id" required="required">

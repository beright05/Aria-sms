           ...
           <div class="card">
              <div class="card-body"> 
                <ul class="nav nav-tabs nav-tabs-info nav-justified">
                        <li class="nav-item"><a class="nav-link <?php if(isset($info)){ echo 'active'; }?>" href="#tab_profile"   role="tab" data-toggle="tab" aria-expanded="true"><i class="fa fa-eye"></i> <?php echo $this->lang->line('profile'); ?></a> </li>
                        <li  class="nav-item"><a class="nav-link <?php if(isset($update)){ echo 'active'; }?>" href="#tab_update"  role="tab"  data-toggle="tab" aria-expanded="false"><i class="fa fa-pencil-square-o"></i> <?php echo $this->lang->line('update'); ?></a> </li>                          
                        <li class="nav-item"><a class="nav-link" href="#tab_guardian_info"   role="tab" data-toggle="tab" aria-expanded="true"><i class="fa fa-paw"></i> <?php echo $this->lang->line('guardian'); ?></a> </li>
                        <li class="nav-item"><a class="nav-link" href="#tab_parent_info"   role="tab" data-toggle="tab" aria-expanded="true"><i class="fa fa-male"></i> <?php echo $this->lang->line('parent'); ?></a> </li>
                        <li  class="nav-item"><a class="nav-link" href="#tab_attendance"  role="tab"  data-toggle="tab" aria-expanded="false"><i class="fa fa-check-circle-o"></i> <?php echo $this->lang->line('attendance'); ?></a> </li>                          
                        <li  class="nav-item"><a class="nav-link" href="#tab_mark"  role="tab"  data-toggle="tab" aria-expanded="false"><i class="fa fa-file-archive-o"></i> <?php echo $this->lang->line('exam_mark'); ?></a> </li>                          
                        <li  class="nav-item"><a class="nav-link" href="#tab_payment"  role="tab"  data-toggle="tab" aria-expanded="false"><i class="fa fa-dollar"></i> <?php echo $this->lang->line('payment'); ?> </a> </li>                          
                        <li  class="nav-item"><a class="nav-link" href="#tab_activity"  role="tab"  data-toggle="tab" aria-expanded="false"><i class="fa fa-clipboard"></i> <?php echo $this->lang->line('activity'); ?> </a> </li>                          
                    </ul>
                    <br/>
                    
                    <div class="tab-content">                  

                        <div  class="container tab-pane <?php if(isset($info)){ echo 'active'; }?>" id="tab_profile">
                            <div class="x_content">  
                                <div class="col-md-12">
                        ...
                        <div  class="container tab-pane " id="tab_guardian_info" >
                        ...
                        <div  class="container tab-pane " id="tab_parent_info" >
                            <table class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                <tbody>
                                    <tr>
                        ...
                        <div  class="container tab-pane " id="tab_attendance" >
                          <table class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                           <thead>
                               <tr>
                   ...
                   <div  class="container tab-pane " id="tab_mark" >
                       <table class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                           <thead>
                               <tr>
                   ...
                   <div  class="container tab-pane " id="tab_payment" >
                       <table class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                           <thead>
                               <tr>
                   ...
                   <div  class="container tab-pane " id="tab_activity" >
                       <table class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                           <thead>
                               <tr>
                               <th><?php echo $this->lang->line('sl_no'); ?></th>
                        ...
                        <div class="container tab-pane" id="tab_update">
                           <div class="x_content"> 
                                ...
                                <div class="row">                  
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            ...
                                            <input  class="form-control"  name="name"  id="name" value="<?php echo isset($profile->name) ?  $profile->name : ''; ?>" placeholder="<?php echo $this->lang->line('name'); ?>" required="required" type="text" autocomplete="off">
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            ...
                                            <input  class="form-control"  name="admission_no"  id="admission_no" value="<?php echo isset($profile->admission_no) ?  $profile->admission_no : ''; ?>" placeholder="<?php echo $this->lang->line('admission_no'); ?>" type="text" readonly="readonly" autocomplete="off">
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            ...
                                            <input  class="form-control"  name="admission_date"  id="edit_admission_date" value="<?php echo isset($profile->admission_date) ?   date('d-m-Y', strtotime($profile->admission_date)) : ''; ?>" placeholder="<?php echo $this->lang->line('admission_date'); ?>"  readonly="readonly" type="text" autocomplete="off">
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                         <div class="item form-group">
                                            ...
                                            <input  class="form-control"  name="dob"  id="edit_dob" value="<?php echo isset($profile->dob) ?  date('d-m-Y', strtotime($profile->dob)) : ''; ?>" placeholder="<?php echo $this->lang->line('birth_date'); ?>"  readonly="readonly" type="text" autocomplete="off">
                                     ...
                                     <div class="col-md-3 col-sm-3 col-xs-12">
                                         <div class="item form-group">
                                             <label for="gender"><?php echo $this->lang->line('gender'); ?> <span class="required">*</span></label>
                                              <select  class="form-control single-select"  name="gender"  id="gender" required="required">
                                     ...
                                     <div class="col-md-3 col-sm-3 col-xs-12">
                                         <div class="item form-group">
                                             <label for="blood_group"><?php echo $this->lang->line('blood_group'); ?></label>
                                              <select  class="form-control single-select" name="blood_group" id="blood_group">
                                                <option value="">--<?php echo $this->lang->line('select'); ?>--</option>
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                         <div class="item form-group">
                                              ...
                                              <input  class="form-control"  name="religion"  id="add_religion" value="<?php echo isset($profile->religion) ?  $profile->religion : ''; ?>" placeholder="<?php echo $this->lang->line('religion'); ?>" type="text" autocomplete="off">
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                         <div class="item form-group">
                                              ...
                                              <input  class="form-control"  name="caste"  id="add_caste" value="<?php echo isset($profile->caste) ?  $profile->caste : ''; ?>" placeholder="<?php echo $this->lang->line('caste'); ?>" type="text" autocomplete="off">
                                ...
                                <div class="row"> 
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            ...
                                            <select  class="form-control single-select" name="guardian_id" id="guardian_id" disabled="disabled">
                                                <option value="">--<?php echo $this->lang->line('select'); ?>--</option>
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            ...
                                            <input  class="form-control"  name="relation_with"  id="relation_with" value="<?php echo isset($profile->relation_with) ?  $profile->relation_with : ''; ?>" placeholder="<?php echo $this->lang->line('relation_with_guardian'); ?>" type="text" autocomplete="off">
                                     ...
                                     <div class="col-md-3 col-sm-3 col-xs-12">
                                         <div class="item form-group">
                                             ...
                                             <input  class="form-control"  name="phone"  id="add_phone" value="<?php echo isset($profile->phone) ?  $profile->phone : ''; ?>" placeholder="<?php echo $this->lang->line('phone'); ?>" type="text" autocomplete="off">
                                     ...
                                     <div class="col-md-3 col-sm-3 col-xs-12">
                                         <div class="item form-group">
                                             ...
                                             <input  class="form-control"  name="national_id"  id="national_id" value="<?php echo isset($profile->national_id) ?  $profile->national_id : ''; ?>" placeholder="<?php echo $this->lang->line('national_id'); ?>" type="text" autocomplete="off">
                                     ...
                                     <div class="col-md-6 col-sm-6 col-xs-12">
                                         <div class="item form-group">
                                             <label for="present_address"><?php echo $this->lang->line('present_address'); ?></label>
                                              <textarea  class="form-control textarea-4column"  name="present_address"  id="add_present_address"  placeholder="<?php echo $this->lang->line('present_address'); ?>"><?php echo isset($profile->present_address) ?  $profile->present_address : ''; ?></textarea>
                                     ...
                                     <div class="col-md-6 col-sm-6 col-xs-12">
                                         <div class="item form-group">
                                            ...
                                            <textarea  class="form-control textarea-4column"  name="permanent_address"  id="add_permanent_address"  placeholder="<?php echo $this->lang->line('permanent'); ?>"><?php echo isset($profile->permanent_address) ?  $profile->permanent_address : ''; ?></textarea>
                                ...
                                <div class="row">                                      
                                     <div class="col-md-3 col-sm-3 col-xs-12">
                                         <div class="item form-group">
                                            ...
                                            <select  class="form-control single-select" name="type_id" id="type_id" disabled="disabled">
                                                <option value="">--<?php echo $this->lang->line('select'); ?>--</option>
                                     ...
                                     <div class="col-md-3 col-sm-3 col-xs-12">
                                         <div class="item form-group">
                                             ...
                                             <select  class="form-control single-select" name="class_id" id="class_id" disabled="disabled">
                                                <option value="">--<?php echo $this->lang->line('select'); ?>--</option>
                                     ...
                                     <div class="col-md-3 col-sm-3 col-xs-12">
                                         <div class="item form-group">
                                            ...
                                            <select  class="form-control single-select" name="section_id" id="edit_section_id" disabled="disabled">
                                                <option value="">--<?php echo $this->lang->line('select'); ?>--</option>
                                            </select>
                                     ...
                                     <div class="col-md-3 col-sm-3 col-xs-12">
                                         <div class="item form-group">
                                            ...
                                            <select  class="form-control single-select" name="group" id="group" disabled="disabled">
                                                <option value="">--<?php echo $this->lang->line('select'); ?>--</option>
                                     ...
                                     <div class="col-md-3 col-sm-3 col-xs-12">
                                         <div class="item form-group">
                                             ...
                                             <input  class="form-control"  name="roll_no"  id="roll_no" readonly="readonly"  value="<?php echo isset($profile->roll_no) ?  $profile->roll_no : ''; ?>" placeholder="<?php echo $this->lang->line('roll_no'); ?>" required="required" type="text" autocomplete="off">
                                     ...
                                     <div class="col-md-3 col-sm-3 col-xs-12">
                                         <div class="item form-group">
                                            ...
                                            <input  class="form-control"  name="registration_no"  id="registration_no" value="<?php echo isset($profile->registration_no) ?  $profile->registration_no : ''; ?>" placeholder="<?php echo $this->lang->line('registration_no'); ?>" disabled="disabled" type="text" autocomplete="off">
                                     ...
                                     <div class="col-md-3 col-sm-3 col-xs-12">
                                         <div class="item form-group">
                                             ...
                                             <select  class="form-control single-select" name="role_id" id="role_id" disabled="disabled">
                                     ...
                                     <div class="col-md-3 col-sm-3 col-xs-12">
                                         <div class="item form-group">
                                            ...
                                            <input  class="form-control"  name="discount"  id="discount" value="<?php echo isset($profile->discount) ?  $profile->amount.'% ('.$profile->discount .')' : ''; ?>" placeholder="<?php echo $this->lang->line('discount'); ?> " disabled="disabled" type="text" autocomplete="off">
                                     ...
                                     <div class="col-md-3 col-sm-3 col-xs-12">
                                         <div class="item form-group">
                                            ...
                                            <input  class="form-control"  name="second_language"  id="second_language" value="<?php echo isset($profile->second_language) ?  $profile->second_language : ''; ?>" placeholder="<?php echo $this->lang->line('second_language'); ?>" type="text" autocomplete="off">
                                ...
                                <div class="row">  
                                     <div class="col-md-3 col-sm-3 col-xs-12">
                                         <div class="item form-group">
                                            ...
                                            <input  class="form-control"  name="father_name"  id="father_name" value="<?php echo isset($profile->father_name) ?  $profile->father_name : ''; ?>" placeholder="<?php echo $this->lang->line('father_name'); ?>" type="text" autocomplete="off">
                                     ...
                                     <div class="col-md-3 col-sm-3 col-xs-12">
                                         <div class="item form-group">
                                            ...
                                            <input  class="form-control"  name="father_phone"  id="father_phone" value="<?php echo isset($profile->father_phone) ?  $profile->father_phone : ''; ?>" placeholder="<?php echo $this->lang->line('father_phone'); ?>"  type="text" autocomplete="off">
                                     ...
                                     <div class="col-md-3 col-sm-3 col-xs-12">
                                         <div class="item form-group">
                                            ...
                                            <input  class="form-control"  name="father_education"  id="father_education" value="<?php echo isset($profile->father_education) ?  $profile->father_education : ''; ?>" placeholder="<?php echo $this->lang->line('father_education'); ?>"  type="text" autocomplete="off">
                                     ...
                                     <div class="col-md-3 col-sm-3 col-xs-12">
                                         <div class="item form-group">
                                            ...
                                            <input  class="form-control"  name="father_profession"  id="father_profession" value="<?php echo isset($profile->father_profession) ?  $profile->father_profession : ''; ?>" placeholder="<?php echo $this->lang->line('father_profession'); ?>"  type="text" autocomplete="off">
                                     ...
                                     <div class="col-md-3 col-sm-3 col-xs-12">
                                         <div class="item form-group">
                                            ...
                                            <input  class="form-control"  name="father_designation"  id="father_designation" value="<?php echo isset($profile->father_designation) ?  $profile->father_designation : ''; ?>" placeholder="<?php echo $this->lang->line('father_designation'); ?>"  type="text" autocomplete="off">
                                ...
                                <div class="row">  
                                     <div class="col-md-3 col-sm-3 col-xs-12">
                                         <div class="item form-group">
                                            ...
                                            <input  class="form-control"  name="mother_name"  id="mother_name" value="<?php echo isset($profile->mother_name) ?  $profile->mother_name : ''; ?>" placeholder="<?php echo $this->lang->line('mother_name'); ?>" type="text" autocomplete="off">
                                     ...
                                     <div class="col-md-3 col-sm-3 col-xs-12">
                                         <div class="item form-group">
                                            ...
                                            <input  class="form-control"  name="mother_phone"  id="mother_phone" value="<?php echo isset($profile->mother_phone) ?  $profile->mother_phone : ''; ?>" placeholder="<?php echo $this->lang->line('mother_phone'); ?>"  type="text" autocomplete="off">
                                     ...
                                     <div class="col-md-3 col-sm-3 col-xs-12">
                                         <div class="item form-group">
                                            ...
                                            <input  class="form-control"  name="mother_education"  id="mother_education" value="<?php echo isset($profile->mother_education) ?  $profile->mother_education : ''; ?>" placeholder="<?php echo $this->lang->line('mother_education'); ?>"  type="text" autocomplete="off">
                                     ...
                                     <div class="col-md-3 col-sm-3 col-xs-12">
                                         <div class="item form-group">
                                            ...
                                            <input  class="form-control"  name="mother_profession"  id="mother_profession" value="<?php echo isset($profile->mother_profession) ?  $profile->mother_profession : ''; ?>" placeholder="<?php echo $this->lang->line('mother_profession'); ?>"  type="text" autocomplete="off">
                                     ...
                                     <div class="col-md-3 col-sm-3 col-xs-12">
                                         <div class="item form-group">
                                            ...
                                            <input  class="form-control"  name="mother_designation"  id="mother_designation" value="<?php echo isset($profile->mother_designation) ?  $profile->mother_designation : ''; ?>" placeholder="<?php echo $this->lang->line('mother_designation'); ?>"  type="text" autocomplete="off">
                                ...
                                <div class="row">                  
                                     ...
                                     <div class="col-md-3 col-sm-3 col-xs-12">
                                         <div class="item form-group">
                                            ...
                                            <input  class="form-control"  name="email"   id="email" value="<?php echo isset($profile->email) ?  $profile->email : ''; ?>" placeholder="<?php echo $this->lang->line('email'); ?>" type="email" autocomplete="off">
                                     ...
                                     <div class="col-md-3 col-sm-3 col-xs-12">
                                         <div class="item form-group">
                                            ...
                                            <input  class="form-control"  name="username"  id="username" readonly="readonly" value="<?php echo isset($profile->username) ?  $profile->username : ''; ?>" placeholder="<?php echo $this->lang->line('username'); ?>" type="text" autocomplete="off">
                                     ...
                                     <div class="col-md-3 col-sm-3 col-xs-12">
                                         <div class="item form-group">
                                            ...
                                            <input  class="form-control"  name="health_condition"  id="health_condition" value="<?php echo isset($profile->health_condition) ?  $profile->health_condition : ''; ?>" placeholder="<?php echo $this->lang->line('health_condition'); ?>" type="text" autocomplete="off">

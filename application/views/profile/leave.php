           ...
           <div class="card">
              <div class="card-body"> 
                <ul class="nav nav-tabs nav-tabs-info nav-justified">
                         <li class="nav-item"><a class="nav-link active" href="#tab_application_list"   role="tab" data-toggle="tab" aria-expanded="true"><i class="fa fa-list-ol"></i> <?php echo $this->lang->line('list'); ?></a> </li>
                        <?php if(has_permission(ADD, 'userleave', 'userleave')){ ?>
                             <?php if(isset($edit)){ ?>
                                 <li  class="nav-item"><a class="nav-link" href="<?php echo site_url('userleave/add'); ?>"  aria-expanded="false"><i class="fa fa-plus-square-o"></i> <?php echo $this->lang->line('add'); ?></a> </li>                          
                             <?php }else{ ?>
                                 <li  class="nav-item"><a class="nav-link" href="#tab_add_application"  role="tab"  data-toggle="tab" aria-expanded="false"><i class="fa fa-plus-square-o"></i> <?php echo $this->lang->line('add'); ?> </a> </li>                          
                             <?php } ?>
                        <?php } ?> 
                        <?php if(isset($edit)){ ?>
                            <li  class="nav-item"><a class="nav-link" href="#tab_edit_application"  role="tab"  data-toggle="tab" aria-expanded="false"><i class="fa fa-pencil-square-o"></i> <?php echo $this->lang->line('edit'); ?></a> </li>                          
                        <?php } ?>
                    </ul>
                    <br/>
                    ...
                    <div class="tab-content">
                        ...
                        <div  class="container tab-pane <?php if(isset($list)){ echo 'active'; }?>" id="tab_application_list" >
                            <div class="x_content">
                        ...
                        <div  class="container tab-pane <?php if(isset($add)){ echo 'active'; }?>" id="tab_add_application">
                            <div class="x_content"> 
                               <?php echo form_open_multipart(site_url('userleave/add'), array('name' => 'add', 'id' => 'add', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="item form-group">  
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select  class="form-control single-select"  name="type_id"  id="add_type_id" required="required" onchange="get_type(this.value)">
                                ...
                                <?php if(logged_in_role_id() == GUARDIAN){ ?>
                                    <div class="item form-group">  
                                       ...
                                       <div class="col-md-6 col-sm-6 col-xs-12">
                                           <select  class="form-control single-select"  name="user_id"  id="user_id" required="required">
                                               <option itemid="" value="">--<?php echo $this->lang->line('select'); ?>--</option>
                                ...
                                <div class="form-group"> 
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control"  name="leave_date"  id="add_leave_date" value="<?php echo isset($post['leave_date']) ?  $post['leave_date'] : ''; ?>" placeholder="<?php echo $this->lang->line('date'); ?>" required="required" type="text" autocomplete="off">
                                ...
                                <div class="form-group"> 
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control"  name="leave_from"  id="add_leave_from" value="<?php echo isset($post['leave_from']) ?  $post['leave_from'] : ''; ?>" placeholder="<?php echo $this->lang->line('leave_from'); ?>" required="required" type="text" autocomplete="off">
                                ...
                                <div class="form-group"> 
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control"  name="leave_to"  id="add_leave_to" value="<?php echo isset($post['leave_to']) ?  $post['leave_to'] : ''; ?>" placeholder="<?php echo $this->lang->line('leave_to'); ?>" required="required" type="text" autocomplete="off">
                        ...
                        <?php if(isset($edit)){ ?>
                            <div  class="container tab-pane <?php if(isset($edit)){ echo 'active'; }?>" id="tab_edit_application">
                            <div class="x_content"> 
                               <?php echo form_open_multipart(site_url('userleave/edit/'.$application->id), array('name' => 'edit', 'id' => 'edit', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                    ...
                                    <div class="item form-group">  
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="type_id"><?php echo $this->lang->line('leave_type'); ?> <span class="required">*</span></label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <select  class="form-control single-select"  name="type_id"  id="edit_type_id" required="required" onchange="get_type(this.value)">
                                                <option itemid="" value="">--<?php echo $this->lang->line('select'); ?>--</option>                                                                                         
                                                <?php foreach($types as $obj ){ ?>
                                    ...
                                    <div class="form-group"> 
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="leave_date"><?php echo $this->lang->line('date'); ?> <span class="required">*</span></label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input  class="form-control"  name="leave_date"  id="edit_leave_date" value="<?php echo isset($application->leave_date) ?  date('d-m-Y', strtotime($application->leave_date)) : ''; ?>" placeholder="<?php echo $this->lang->line('date'); ?>" required="required" type="text" autocomplete="off">
                                            <div class="help-block"><?php echo form_error('leave_date'); ?></div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group"> 
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="leave_from"><?php echo $this->lang->line('leave_from'); ?> <span class="required">*</span></label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input  class="form-control"  name="leave_from"  id="edit_leave_from" value="<?php echo isset($application->leave_from) ?  date('d-m-Y', strtotime($application->leave_from)) : ''; ?>" placeholder="<?php echo $this->lang->line('leave_from'); ?>" required="required" type="text" autocomplete="off">
                                            <div class="help-block"><?php echo form_error('leave_from'); ?></div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group"> 
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="leave_to"><?php echo $this->lang->line('leave_to'); ?> <span class="required">*</span></label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input  class="form-control"  name="leave_to"  id="edit_leave_to" value="<?php echo isset($application->leave_to) ?  date('d-m-Y', strtotime($application->leave_to)) : ''; ?>" placeholder="<?php echo $this->lang->line('leave_to'); ?>" required="required" type="text" autocomplete="off">
                                            <div class="help-block"><?php echo form_error('leave_to'); ?></div>
                                        </div>
                                    </div>

            ...
            <div class="card-body">
              <div class="media">
               <div class="media-icons-big">
                  <span class="border-top-left-radius"></span> <i class="icon-people icons"></i>
              </div>
              <div class="media-body text-right mt-3">
                <h6 class="text-uppercase text-white"><?php echo $this->lang->line('student'); ?></h6>
                <h4 class="text-white"><?php echo $total_student ? $total_student : 0; ?></h4>
              </div>
            </div>
            </div>
          </div>
        ...
        <div class="col-12 col-sm-6 col-lg-6 col-xl-3">
          <div class="card gradient-shifter">
            <div class="card-body">
              ...
              <div class="media-body text-right mt-3">
                <h6 class="text-uppercase text-white"><?php echo $this->lang->line('guardian'); ?></h6>
                <h4 class="text-white"><?php echo $total_guardian ? $total_guardian : 0; ?></h4>
              </div>
            </div>
            </div>
          </div>
        ...
        <div class="col-12 col-sm-6 col-lg-6 col-xl-3">
          <div class="card gradient-meridian">
            <div class="card-body">
              ...
              <div class="media-body text-right mt-3">
                <h6 class="text-uppercase text-white"><?php echo $this->lang->line('employee'); ?></span></h6>
                <h4 class="text-white"></h4>
                <h4 class="text-white"><?php echo $total_employee ? $total_employee :0; ?></h4>
              </div>
            </div>
            </div>
          </div>
        ...
        <div class="col-12 col-sm-6 col-lg-6 col-xl-3">
          <div class="card bg-primary shadow-primary">
            <div class="card-body">
              ...
              <div class="media-body text-right mt-3">
                <h6 class="text-uppercase text-white"><?php echo $this->lang->line('teacher'); ?></h6>
                <h4 class="text-white"><?php echo $total_teacher ? $total_teacher : 0; ?></h4>
              </div>
            </div>
            </div>
          </div>
        ...
        <div class="col-12 col-sm-6 col-lg-6 col-xl-3">
          <div class="card gradient-orange">
            <div class="card-body">
              <div class="media">
               <div class="media-icons-big">
                  <span class="border-top-left-radius"></span> <i class="icon-credit-card"></i>
              </div>
              <div class="media-body text-right mt-3">
                <h6 class="text-uppercase text-white"><?php echo $this->lang->line('income'); ?></h6>
                <h4 class="text-white"> <?php echo isset($school_setting->currency_symbol) ? $school_setting->currency_symbol : $this->global_setting->currency_symbol;  ?><?php echo $total_income ? $total_income : '0.00'; ?></h4>
              </div>
            </div>
            </div>
          </div>
        ...
        <div class="col-12 col-sm-6 col-lg-6 col-xl-3">
          <div class="card bg-danger shadow-danger">
            <div class="card-body">
              ...
              <div class="media-body text-right mt-3">
                <h6 class="text-uppercase text-white"><?php echo $this->lang->line('expenditure'); ?></h6>
                <h4 class="text-white"><?php echo isset($school_setting->currency_symbol) ? $school_setting->currency_symbol : $this->global_setting->currency_symbol;  ?>
                <?php echo $total_expenditure? $total_expenditure : '0.00'; ?></h4>
              </div>
            </div>
            </div>
          </div>
        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel tile overflow_hidden">
                ...
                <div class="x_content">
                    ...
                    <script type="text/javascript" src='<?php echo VENDOR_URL; ?>fullcalendar/js/jquery-ui.custom.min.js'></script>
                    <script type="text/javascript" src='<?php echo VENDOR_URL; ?>fullcalendar/js/fullcalendar.js'></script>
                    <script type="text/javascript" src='<?php echo VENDOR_URL; ?>fullcalendar/js/fullcalendar-custom-script.js'></script> 
                    <script type="text/javascript">
                        $(function () {

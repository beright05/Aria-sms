              ...
              <div class="card-body"> 
                <ul class="nav nav-tabs nav-tabs-info nav-justified">
                    <?php if($this->session->userdata('role_id') == SUPER_ADMIN){ ?>     
                         <li class="nav-item"><a class="nav-link active" href="#tab_about_list"   role="tab" data-toggle="tab" aria-expanded="true"><i class="fa fa-list-ol"></i>  <?php echo $this->lang->line('list'); ?></a> </li>
                    <?php } ?>  
                    <?php if(isset($edit)){ ?>
                        <li  class="active"><a class="nav-link" href="#tab_edit_about"  role="tab"  data-toggle="tab" aria-expanded="false"><i class="fa fa-pencil-square-o"></i> <?php echo $this->lang->line('edit'); ?></a> </li>                          
                    <?php } ?>  
                    </ul>
                    <br/>
                    
                    <div class="tab-content">
                        <div  class="container tab-pane <?php if(isset($list)){ echo 'active'; }?>" id="tab_about_list" >
                            <div class="x_content">
                        ...
                        <?php if(isset($edit)){ ?>
                        <div class="container tab-pane active" id="tab_edit_about">
                            <div class="x_content"> 
                               <?php echo form_open_multipart(site_url('frontend/about/edit/'.$school->id), array('name' => 'edit', 'id' => 'edit', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <textarea  class="form-control"  name="about_text"  id="edit_about_text" placeholder="<?php echo $this->lang->line('about_school'); ?>"><?php echo isset($school->about_text) ?  $school->about_text : ''; ?></textarea>

           ...
           <div class="card">
              <div class="card-body"> 
                <ul class="nav nav-tabs nav-tabs-info nav-justified">
                     <li class="nav-item"><a class="nav-link active" href="#tab_page_list"   role="tab" data-toggle="tab" aria-expanded="true"><i class="fa fa-list-ol"></i> <?php echo $this->lang->line('list'); ?></a> </li>
                        <?php if(has_permission(ADD, 'frontend', 'frontend')){ ?>
                            
                          <?php if(isset($edit)){ ?>
                                 <li  class="nav-item"><a class="nav-link" href="<?php echo site_url('frontend/add'); ?>"  role="tab"  aria-expanded="false"><i class="fa fa-plus-square-o"></i> <?php echo $this->lang->line('create_page'); ?></a> </li>                          
                          <?php }else{ ?>
                                 <li  class="nav-item"><a class="nav-link" href="#tab_add_page"  role="tab"  data-toggle="tab" aria-expanded="false"><i class="fa fa-plus-square-o"></i> <?php echo $this->lang->line('create_page'); ?></a> </li>                          
                          <?php } ?>   
                           
                        <?php } ?>                            
                        <?php if(isset($edit)){ ?>
                            <li  class="nav-item"><a class="nav-link" href="#tab_edit_page"  role="tab"  data-toggle="tab" aria-expanded="false"><i class="fa fa-pencil-square-o"></i> <?php echo $this->lang->line('edit'); ?></a> </li>                          
                        <?php } ?>  
                            
                         <li class="li-class-list">
                        <?php if($this->session->userdata('role_id') == SUPER_ADMIN){  ?>                                 
                             <select  class="form-control single-select" onchange="get_page_by_school(this.value);">
                    ...
                    <div class="tab-content">
                        <div  class="container tab-pane <?php if(isset($list)){ echo 'active'; }?>" id="tab_page_list" >
                            <div class="x_content">
                        ...
                        <div  class="container tab-pane <?php if(isset($add)){ echo 'active'; }?>" id="tab_add_page">
                            <div class="x_content"> 
                               <?php echo form_open_multipart(site_url('frontend/add'), array('name' => 'add', 'id' => 'add', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        ...
                                        <select  class="form-control single-select" name="page_location" id="page_location" required="required">
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control"  name="page_title"  id="page_title" value="<?php echo isset($post['page_title']) ?  $post['page_title'] : ''; ?>" placeholder="<?php echo $this->lang->line('title'); ?>" required="required" type="text" autocomplete="off">
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control"  name="page_slug"  id="page_slug" value="<?php echo isset($post['page_slug']) ?  $post['page_slug'] : ''; ?>" placeholder="<?php echo $this->lang->line('url_slug'); ?>" required="required" type="text" autocomplete="off">
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <textarea  class="form-control"  name="page_description"  id="add_page_description" placeholder="<?php echo $this->lang->line('description'); ?>"><?php echo isset($post['page_description']) ?  $post['page_description'] : ''; ?></textarea>
                        ...
                        <?php if(isset($edit)){ ?>
                        <div class="container tab-pane active" id="tab_edit_page">
                            <div class="x_content"> 
                               <?php echo form_open_multipart(site_url('frontend/edit/'.$page->id), array('name' => 'edit', 'id' => 'edit', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control"  name="page_title"  id="page_title" value="<?php echo isset($page->page_title) ?  $page->page_title : ''; ?>" placeholder="<?php echo $this->lang->line('title'); ?>" required="required" type="text" autocomplete="off">
                                        <div class="help-block"><?php echo form_error('page_title'); ?></div>
                                    </div>
                                </div>
                                ...
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="page_slug"><?php echo $this->lang->line('url_slug'); ?><span class="required">*</span> </label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control"  name="page_slug"  id="page_slug" value="<?php echo isset($page->page_slug) ?  $page->page_slug : ''; ?>" placeholder="<?php echo $this->lang->line('url_slug'); ?>" required="required" type="text" autocomplete="off">
                                        <div class="text-info">Ex: terms-and-condition. [ Must be english text ]</div>
                                        <div class="help-block"><?php echo form_error('page_slug'); ?></div>
                                    </div>
                                </div>
                                ...
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="page_description"><?php echo $this->lang->line('description'); ?></label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <textarea  class="form-control"  name="page_description"  id="edit_page_description" placeholder="<?php echo $this->lang->line('description'); ?>"><?php echo isset($page->page_description) ?  $page->page_description : ''; ?></textarea>
                                        <div class="help-block"><?php echo form_error('page_description'); ?></div>
                                    </div>
                                </div>                                                         

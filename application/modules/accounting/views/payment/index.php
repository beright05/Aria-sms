            ...
            <div class="x_content">
                <div class="" data-example-id="togglable-tabs">
                    ...
                    <div class="tab-content"> 
                         <div  class="container tab-pane active" id="tab_fee_list" >
                        <div class="x_content"> 
                           <?php echo form_open(site_url('accounting/payment/paid/'.$invoice_id), array('name' => 'add', 'id' => 'add', 'class'=>'form-horizontal form-label-left'), ''); ?>
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input  class="form-control"  name="amount"  id="amount" value="<?php echo $due_amount; ?>" placeholder="<?php echo $this->lang->line('amount'); ?>" required="required" type="number" step="any">
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <select  class="form-control single-select"  name="payment_method"  id="payment_method" required="required" onchange="check_payment_method(this.value);">
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input  class="form-control"  name="stripe_card_number"  id="stripe_card_number" value="" placeholder="<?php echo $this->lang->line('card_number'); ?>"  type="text" autocomplete="off">
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input  class="form-control"  name="card_cvv"  id="card_cvv" value="" placeholder="<?php echo $this->lang->line('cvv'); ?>"  type="text" autocomplete="off">
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-3 col-sm-3 col-xs-6">
                                    <input  class="form-control"  name="expire_month"  id="expire_month" value="" placeholder="<?php echo $this->lang->line('expire_month'); ?>"  type="text" autocomplete="off">
                                    <div class="help-block"><?php echo form_error('expire_month'); ?></div>
                                </div>
                                <div class="col-md-3 col-sm-3 col-xs-6">
                                    <input  class="form-control"  name="expire_year"  id="expire_year" value="" placeholder="<?php echo $this->lang->line('expire_year'); ?>"  type="text" autocomplete="off">
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input  class="form-control"  name="pum_first_name"  id="pum_first_name" value="" placeholder="<?php echo $this->lang->line('first_name'); ?>"  type="text" autocomplete="off">
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input  class="form-control"  name="pum_email"  id="pum_email" value="" placeholder="<?php echo $this->lang->line('email'); ?>"  type="text" autocomplete="off">
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input  class="form-control"  name="pum_phone"  id="pum_phone" value="" placeholder="<?php echo $this->lang->line('phone'); ?>"  type="text" autocomplete="off">
                           ...
                           <!-- For PayStack Start-->
                            <div class="display fn_paystack"  style="<?php if(isset($post) && $post['payment_method'] == 'paystack'){ echo 'display:block;';} ?>">
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control"  name="stack_email"  id="stack_email" value="" placeholder="<?php echo $this->lang->line('email'); ?>"  type="text" autocomplete="off">
                           ...
                           <!-- For Receipt Start-->
                            <div class="display fn_receipt"  style="<?php if(isset($post) && $post['payment_method'] == 'receipt'){ echo 'display:block;';} ?>">
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control"  name="bank_receipt"  id="bank_receipt" value="" placeholder="<?php echo $this->lang->line('bank_receipt'); ?>"  type="text" autocomplete="off">

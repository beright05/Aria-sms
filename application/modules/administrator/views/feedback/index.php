           ...
           <div class="card">
              <div class="card-body"> 
                <ul class="nav nav-tabs nav-tabs-info nav-justified">
                         <li class="nav-item"><a class="nav-link active"  href="#tab_feedback_list"   role="tab" data-toggle="tab" aria-expanded="true"><i class="fa fa-list-ol"></i> <?php echo $this->lang->line('list'); ?></a> </li>
                           
                        <?php if(isset($edit)){ ?>
                            <li  class="active"><a class="nav-link" href="#tab_edit_feedback"  role="tab"  data-toggle="tab" aria-expanded="false"><i class="fa fa-pencil-square-o"></i> <?php echo $this->lang->line('edit'); ?></a> </li>                          
                        <?php } ?>  
                    </ul>
                    <br/>
                    
                    <div class="tab-content">
                        <div  class="container tab-pane <?php if(isset($list)){ echo 'active'; }?>" id="tab_feedback_list" >
                            <div class="x_content">
                        ...
                        <div  class="container tab-pane <?php if(isset($add)){ echo 'active'; }?>" id="tab_add_feedback">
                            <div class="x_content"> 
                               <?php echo form_open(site_url('administrator/feedback/add'), array('name' => 'add', 'id' => 'add', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <textarea  class="form-control"  name="feedback"  id="feedback" required="required" placeholder="<?php echo $this->lang->line('feedback'); ?>"><?php echo isset($post['feedback']) ?  $post['feedback'] : ''; ?></textarea>
                        ...
                        <?php if(isset($edit)){ ?>
                        <div class="container tab-pane active" id="tab_edit_feedback">
                            <div class="x_content">
                               ...
                               <?php echo form_open(site_url('administrator/feedback/edit/'.$feedback->id), array('name' => 'edit', 'id' => 'edit', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="feedback"><?php echo $this->lang->line('feedback'); ?> <span class="required">*</span></label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <textarea  class="form-control"  name="feedback"  id="feedback" required="required" placeholder="<?php echo $this->lang->line('feedback'); ?>"><?php echo isset($feedback->feedback) ?  $feedback->feedback : ''; ?></textarea>
                                        <div class="help-block"><?php echo form_error('feedback'); ?></div>
                                    </div>
                                </div>

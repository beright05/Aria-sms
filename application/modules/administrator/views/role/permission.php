           ...
           <div class="card">
              <div class="card-body"> 
                <ul class="nav nav-tabs nav-tabs-info nav-justified">                 
                        <li  class="nav-item"><a class="nav-link active" href="#tab_perimission" role="tab" data-toggle="tab" aria-expanded="false"><i class="fa fa-gear"></i> <?php echo $this->lang->line('role_permission'); ?></a></li>                          
                        <li class="nav-item">
                            <select  class="form-control single-select" id="filter_class_id" name="class_id"  style="width:auto;" onchange="get_permission_setting_by_role(this.value)">
                    ...
                    <div class="tab-content">
                        <div  class="container tab-pane <?php if(isset($list)){ echo 'active'; }?>" id="tab_role_list" >
                            <div class="x_content">
                            ...
                            <table class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                <thead>
                                    <tr>
                                        ...
                                        <th><?php echo $this->lang->line('view'); ?> &nbsp; <input type="checkbox" id="fn_view" class="filled-in chk-col-primary" value="1" /> </th>                  
                                        <th><?php echo $this->lang->line('add'); ?>  &nbsp;<input type="checkbox" id="fn_add"  class="filled-in chk-col-primary" value="1" /></th>                  
                                        <th><?php echo $this->lang->line('edit'); ?>  &nbsp;<input type="checkbox" id="fn_edit" class="filled-in chk-col-primary" value="1" /></th> 
                                        <th><?php echo $this->lang->line('delete'); ?>  &nbsp; <input type="checkbox" id="fn_delete" class="filled-in chk-col-primary" value="1" /></th> 
                                     </tr>
                                </thead>
                                <tbody>
                                        ...
                                        <?php if(isset($operations) && !empty($operations)){ ?>
                                            ...
                                            <tr>           
                                                ...
                                                <td colspan="2" class="role-text" style="padding-left: 120px;">
                                                   ...
                                                   <input type="hidden" name="operation[<?php echo $op->id; ?>]" id="operation[]"  value="<?php echo $op->id; ?>" />
                                               
                                                </td>    
                                                <td>
                                                    <?php if($op->is_view_vissible){ ?>
                                                        <input type="checkbox" id="is_view[<?php echo $op->id; ?>]" class="filled-in chk-col-primary fn_view" name="is_view[<?php echo $op->id; ?>]" value="1" <?php if(isset($permission->is_view) && $permission->is_view == 1){ echo 'checked="checked"'; } ?> />
                                                        <label for="is_view[<?php echo $op->id; ?>]"></label></td>
                                                    <?php } ?>
                                                
                                                <td>
                                                    <?php if($op->is_add_vissible){ ?>
                                                        <input type="checkbox" id="is_add[<?php echo $op->id; ?>]" class="filled-in chk-col-info fn_add"  name="is_add[<?php echo $op->id; ?>]" value="1" <?php if(isset($permission->is_add) && $permission->is_add == 1){ echo 'checked="checked"'; } ?> />
                                                        <label for="is_add[<?php echo $op->id; ?>]"></label></td>
                                                    <?php } ?>
                                                <td>
                                                    <?php if($op->is_edit_vissible){ ?>
                                                        <input type="checkbox" id="is_edit[<?php echo $op->id; ?>]" class="filled-in chk-col-warning fn_edit" name="is_edit[<?php echo $op->id; ?>]" value="1" <?php if(isset($permission->is_edit) && $permission->is_edit == 1){ echo 'checked="checked"'; } ?> />
                                                        <label for="is_edit[<?php echo $op->id; ?>]"></label></td>
                                                     <?php } ?>
                                                
                                                <td>
                                                    <?php if($op->is_delete_vissible){ ?>
                                                        <input type="checkbox" id="is_delete[<?php echo $op->id; ?>]" class="filled-in chk-col-danger fn_delete"  name="is_delete[<?php echo $op->id; ?>]" value="1" <?php if(isset($permission->is_delete) && $permission->is_delete == 1){ echo 'checked="checked"'; } ?> />
                                                         <label for="is_delete[<?php echo $op->id; ?>]"></label></td>                     
                                                    <?php } ?>
                                             </tr>                                            

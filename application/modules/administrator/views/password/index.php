                ...
                <div class="col-lg-12">
                    ...
                    <br/>
                     <div class="tab-content">
                        <div  class="container tab-pane active" id="tab_password_reset" >
                            <div class="x_content">
                                ...
                                <div class="item form-group display"> 
                                 ...
                                 <div class="item form-group">
                                     ...
                                     <div class="col-md-6 col-sm-6 col-xs-12">
                                         <input  class="form-control"  name="conf_password"  id="conf_password" value="" placeholder="<?php echo $this->lang->line('confirm_password'); ?>" required="required" type="password" autocomplete="off">

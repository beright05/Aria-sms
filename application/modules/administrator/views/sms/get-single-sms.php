<div class="" data-example-id="togglable-tabs">
    ...
    <br/>
     ...
     <div class="tab-content">   
        <div  class="container tab-pane active" id="tab_pop_twilio_setting" > 
        ...
        <div  class="container tab-pane" id="tab_pop_clickatell_setting" > 
            <table class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
            <tbody>           
                <tr>
        ...
        <div  class="container tab-pane" id="tab_pop_bulk_setting" > 
            <table class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
            <tbody>           
                <tr>
                    <th width="50%"><?php echo $this->lang->line('username'); ?></th>
        ...
        <div  class="container tab-pane" id="tab_pop_msg91_setting" > 
            <table class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
            <tbody>           
                <tr>
        ...
        <div  class="container tab-pane" id="tab_pop_plivo_setting" > 
            <table class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
            <tbody>           
                <tr>
        ...
        <div  class="container tab-pane" id="tab_pop_textlocal_setting" > 
            <table class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
            <tbody>           
                <tr>
                    <th width="50%"><?php echo $this->lang->line('username'); ?></th>
        ...
        <div  class="container tab-pane" id="tab_pop_smscountry_setting" > 
            <table class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
            <tbody>           
                <tr>
                    <th width="50%"><?php echo $this->lang->line('username'); ?></th>
        ...
        <div  class="container tab-pane" id="tab_pop_betasms_setting" > 
            <table class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
            <tbody>           
                <tr>
                    <th width="50%"><?php echo $this->lang->line('username'); ?></th>
        ...
        <div  class="container tab-pane" id="tab_pop_bulkpk_setting" > 
            <table class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
            <tbody>           
                <tr>
                    <th width="50%"><?php echo $this->lang->line('username'); ?></th>
        ...
        <div  class="container tab-pane" id="tab_pop_cluster_setting" > 
            <table class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
            <tbody>           
                <tr>
                    <th width="50%"><?php echo $this->lang->line('auth_key'); ?></th>
        ...
        <div  class="container tab-pane" id="tab_pop_alpha_setting" > 
            <table class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
            <tbody>           
                <tr>
                    <th width="50%"><?php echo $this->lang->line('username'); ?></th>
        ...
        <div  class="container tab-pane" id="tab_pop_bdbulk_setting" > 
            <table class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
            <tbody>           
                <tr>
                    <th><?php echo $this->lang->line('hash_key'); ?></th>
        ...
        <div  class="container tab-pane" id="tab_pop_mimsms_setting" > 
            <table class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
            <tbody>           
                <tr>
                    <th><?php echo $this->lang->line('api_key'); ?></th>

                ...
                <div class="row">
                    ...
                    <div class="col-md-2 col-sm-2 col-xs-12">
                        <div class="item form-group"> 
                            ...
                            <select  class="form-control"  name="role_id"  id="role_id" required="required" onchange="get_user_by_role(this.value, '', '');">
                    ...
                    <div class="col-md-2 col-sm-2 col-xs-12 display" style="display:<?php if(isset($class_id)){ echo 'block';} ?>">
                        <div class="item form-group"> 
                            ...
                            <select  class="form-control"  name="class_id"  id="class_id"  onchange="get_user('', this.value,'');">
                                <option value="">--<?php echo $this->lang->line('select'); ?>--</option>  

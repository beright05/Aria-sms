<div class="" data-example-id="togglable-tabs">
    <ul  class="nav nav-tabs flex-column">
        <li  class="nav-item"><a class="nav-link py-4 active" href="#tab_pop_paypal_setting"  role="tab"  data-toggle="tab" aria-expanded="false"><i class="fa fa-gear"></i> <?php echo $this->lang->line('paypal'); ?></a> </li>                          
        ...
        <li class="nav-item"  class=""><a href="#tab_pop_pumoney_setting"  role="tab"  data-toggle="tab" aria-expanded="false"><i class="fa fa-gear"></i> <?php echo $this->lang->line('payumoney'); ?></a> </li>                          
        ...
        <li class="nav-item"  class=""><a href="#tab_pop_paytm_setting"  role="tab"  data-toggle="tab" aria-expanded="false"><i class="fa fa-gear"></i> <?php echo $this->lang->line('paytm'); ?></a> </li>                          
        <li  class="nav-item" class=""><a href="#tab_pop_paystack_setting"  role="tab"  data-toggle="tab" aria-expanded="false"><i class="fa fa-gear"></i> <?php echo $this->lang->line('pay_stack'); ?></a> </li>                          
    </ul>
    <br/>
    
     <div class="tab-content">   
         
        <div  class="container tab-pane active" id="tab_pop_paypal_setting" > 
        ...
        <div  class="container tab-pane display" id="tab_pop_stripe_setting" > 
            <table class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
            <tbody>           
                <tr>
        ...
        <div  class="container tab-pane" id="tab_pop_pumoney_setting" > 
            <table class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
            <tbody>           
                <tr>
        ...
        <div  class="container tab-pane display" id="tab_pop_ccavenue_setting" > 
            <table class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
            <tbody>           
                <tr>
        ...
        <div  class="container tab-pane" id="tab_pop_paytm_setting" > 
            <table class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
            <tbody>           
                <tr>
        ...
        <div  class="container tab-pane" id="tab_pop_paystack_setting" > 
            <table class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
            <tbody>           
                <tr>
                    <th width="40%"><?php echo $this->lang->line('secret_key'); ?></th>

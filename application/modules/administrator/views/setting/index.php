            ...
            <div class="x_title">
             ...
             <div class="x_content">
                     ...
                     <div class="tab-content">
                         <div class="container tab-pane active" id="tab_setting">
                            <div class="x_content"> 
                                ...
                                <input type="hidden" value="<?php echo isset($setting) ? $setting->id : ''; ?>" name="id" />
                                 ...
                                 <div class="item form-group">
                                   ...
                                   <div class="col-md-6 col-sm-6 col-xs-12">                                      
                                        <input  class="form-control"  name="brand_name"  id="brand_name" value="<?php echo isset($setting) ?  $setting->brand_name : ''; ?>" placeholder="<?php echo $this->lang->line('brand_name'); ?> " type="text" autocomplete="off">
                                ...
                                <div class="item form-group">
                                   ...
                                   <div class="col-md-6 col-sm-6 col-xs-12">                                      
                                        <input  class="form-control"  name="brand_title"  id="brand_title" value="<?php echo isset($setting) ?  $setting->brand_title : ''; ?>" placeholder="<?php echo $this->lang->line('brand_title'); ?> " type="text" autocomplete="off">
                                ...
                                <div class="item form-group">
                                   ...
                                   <div class="col-md-6 col-sm-6 col-xs-12">                                      
                                        <input  class="form-control"  name="currency"  id="currency" value="<?php echo isset($setting) ?  $setting->currency : ''; ?>" placeholder="<?php echo $this->lang->line('currency'); ?> " type="text" autocomplete="off">
                                ...
                                <div class="item form-group">
                                   ...
                                   <div class="col-md-6 col-sm-6 col-xs-12">                                      
                                        <input  class="form-control"  name="currency_symbol"  id="currency_symbol" value="<?php echo isset($setting) ?  $setting->currency_symbol : ''; ?>" placeholder="<?php echo $this->lang->line('currency_symbol'); ?> " type="text" autocomplete="off">
                                ...
                                <div class="item form-group">
                                    <label  class="control-label col-md-3 col-sm-3 col-xs-12"  for="default_time_zone"><?php echo $this->lang->line('default_time_zone'); ?> <span class="required">*</span></label>
                                        ...
                                        <select  class="form-control single-select"  name="time_zone" required="required">
                                            <option value="">--<?php echo $this->lang->line('select'); ?>--</option>
                                ...
                                <div class="item form-group">
                                   ...
                                   <div class="col-md-6 col-sm-6 col-xs-12">
                                    ...
                                    <select  class="form-control single-select"  name="date_format" required="required">
                                        <option value="">--<?php echo $this->lang->line('select'); ?>--</option>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        ...
                                        <?php } ?>
                                        <div class="btn btn-default btn-file"><i class="fa fa-paperclip"></i> <?php echo $this->lang->line('upload'); ?>
                                            <input  class="form-control"  name="favicon_icon" id="favicon_icon" type="file">
                                        </div>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        ...
                                        <?php } ?>
                                        <div class="btn btn-default btn-file"><i class="fa fa-paperclip"></i> <?php echo $this->lang->line('upload'); ?>
                                            <input  class="form-control"  name="splash_image" id="splash_image" type="file">
                                        </div>
                                ...
                                <div class="item form-group">
                                   ...
                                   <div class="col-md-6 col-sm-6 col-xs-12">                                      
                                        <input  class="form-control"  name="brand_footer"  id="brand_footer" value="<?php echo isset($setting) ?  $setting->brand_footer : ''; ?>" placeholder="<?php echo $this->lang->line('brand_footer'); ?> " type="text" autocomplete="off">
                                ...
                                <div class="item form-group">
                                   ...
                                   <div class="col-md-6 col-sm-6 col-xs-12">                                      
                                        <input  class="form-control"  name="google_analytics"  id="google_analytics" value="<?php echo isset($setting) ?  $setting->google_analytics : ''; ?>" placeholder="<?php echo $this->lang->line('google_analytics'); ?> " type="text" autocomplete="off">

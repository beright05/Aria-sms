              ...
              <div class="card-body"> 
                <ul class="nav nav-tabs nav-tabs-info nav-justified">
                        ...
                        <?php if(has_permission(ADD, 'certificate', 'type')){ ?>
                            ...
                            <?php if(isset($edit)){ ?>
                                 <li  class="nav-item"><a class="nav-link" href="<?php echo site_url('certificate/type/add'); ?>"  aria-expanded="false"><i class="fa fa-plus-square-o"></i> <?php echo $this->lang->line('add'); ?></a> </li>                          
                             <?php }else{ ?>
                        ...
                        <?php } ?>
                        <?php if(isset($edit)){ ?>
                            <li  class="nav-item"><a class="nav-link" href="#tab_edit_type"  role="tab"  data-toggle="tab" aria-expanded="false"><i class="fa fa-pencil-square-o"></i> <?php echo $this->lang->line('edit'); ?></a> </li>                          
                        <?php } ?>                            
                    ...
                    <div class="tab-content">
                                ...
                                <div class="col-md-8 col-sm-8 col-xs-12">
                                    ...
                                    <div class="item form-group">
                                         ...
                                         <div class="col-md-9 col-sm-9 col-xs-12">
                                             <input  class="form-control"  name="name"  id="name" value="<?php echo isset($name) ?  $name : ''; ?>" placeholder="<?php echo $this->lang->line('certificate_name'); ?>" required="required" type="text" autocomplete="off">
                                     ...
                                     <div class="item form-group">
                                         ...
                                         <div class="col-md-9 col-sm-9 col-xs-12">
                                             <input  class="form-control"  name="top_title"  id="top_title" value="<?php echo isset($top_title) ?  $top_title : ''; ?>" placeholder="<?php echo $this->lang->line('school_name'); ?>" required="required" type="text" autocomplete="off">
                                     ...
                                     <div class="item form-group">
                                         ...
                                         <div class="col-md-9 col-sm-9 col-xs-12">
                                             <textarea  class="form-control"  name="main_text"  id="main_text" required="required" placeholder="<?php echo $this->lang->line('main_certificate_text'); ?>"><?php echo isset($main_text) ?  $main_text : ''; ?></textarea>
                                     ...
                                     <div class="item form-group">
                                         ...
                                         <div class="col-md-9 col-sm-9 col-xs-12">
                                             <input  class="form-control"  name="footer_middle"  id="footer_middle" value="<?php echo isset($footer_middle) ?  $footer_middle : ''; ?>" placeholder="<?php echo $this->lang->line('footer_middle'); ?>"  type="text" autocomplete="off">
                                     ...
                                     <div class="item form-group">
                                         ...
                                         <div class="col-md-9 col-sm-9 col-xs-12">
                                             <div class="btn btn-default btn-file">
                                                 ...
                                                 <input  class="form-control"  name="background"  id="background" type="file">
                                             </div>
                            ...
                            <div class="x_content"> 
                                <div class="col-md-8 col-sm-8 col-xs-12">
                                    ...
                                    <div class="item form-group">
                                         ...
                                         <div class="col-md-9 col-sm-9 col-xs-12">
                                             <input  class="form-control"  name="name"  id="name" value="<?php echo isset($certificate) ? $certificate->name : ''; ?>" placeholder="<?php echo $this->lang->line('certificate_name'); ?>" required="required" type="text" autocomplete="off">
                                             <div class="help-block"><?php echo form_error('name'); ?></div>
                                         </div>
                                     </div>
                                     ...
                                     <div class="item form-group">
                                         <label class="control-label col-md-3 col-sm-3 col-xs-12" for="top_title"><?php echo $this->lang->line('school_name'); ?> <span class="required">*</span></label>
                                         <div class="col-md-9 col-sm-9 col-xs-12">
                                             <input  class="form-control"  name="top_title"  id="top_title" value="<?php echo isset($certificate) ? $certificate->top_title : ''; ?>" placeholder="<?php echo $this->lang->line('school_name'); ?>" required="required" type="text" autocomplete="off">
                                             <div class="help-block"><?php echo form_error('top_title'); ?></div>
                                         </div>
                                     </div>
                                     ...
                                     <div class="item form-group">
                                         <label class="control-label col-md-3 col-sm-3 col-xs-12" for="main_text"> <?php echo $this->lang->line('main_certificate_text'); ?> <span class="required">*</span></label>
                                         <div class="col-md-9 col-sm-9 col-xs-12">
                                             <textarea  class="form-control"  name="main_text"  id="edit_main_text" required="required" placeholder="<?php echo $this->lang->line('main_certificate_text'); ?>"><?php echo isset($certificate) ? $certificate->main_text : ''; ?></textarea>
                                             <div class="help-block"><?php echo form_error('main_text'); ?></div>
                                             <div class="col-md-12 col-sm-12 col-xs-12">
                                                <div class="fn_add_tag"></div>
                                            </div>
                                     ...
                                     <div class="item form-group">
                                         <label class="control-label col-md-3 col-sm-3 col-xs-12" for="footer_middle"> <?php echo $this->lang->line('footer_middle'); ?></label>
                                         <div class="col-md-9 col-sm-9 col-xs-12">
                                             <input  class="form-control"  name="footer_middle"  id="footer_middle" value="<?php echo isset($certificate) ? $certificate->footer_middle : ''; ?>" placeholder="<?php echo $this->lang->line('footer_middle'); ?>" type="text" autocomplete="off">
                                             <div class="help-block"><?php echo form_error('footer_middle'); ?></div>
                                         </div>
                                     </div>
                        ...
                        <?php if(isset($detail)){ ?>
                             <div class="container tab-pane active" id="tab_view_type">
                                <div class="x_content"> 

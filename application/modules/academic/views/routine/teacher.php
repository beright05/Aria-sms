            ...
            <div class="x_content">
                <div class="" data-example-id="togglable-tabs">
                    ...
                    <ul  class="nav nav-tabs bordered  no-print">
                         <li class="nav-item"><a href="#tab_routine_list"   role="tab" data-toggle="tab" aria-expanded="true"><i class="fa fa-list-ol"></i> <?php echo $this->lang->line('class_routine'); ?></a> </li>
                    </ul>
                    <br/>
                    ...
                    <div class="tab-content">
                        <div  class="container tab-pane <?php if(isset($list)){ echo 'active'; }?>" id="tab_routine_list" >                            
                            <div class="x_content">                             
                                ...
                                <div  class="container tab-pane active" id="tab_section_teacher" >
                                    <div class="x_content">

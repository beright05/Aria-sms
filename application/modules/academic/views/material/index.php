           ...
           <div class="card">
              <div class="card-body"> 
                <ul class="nav nav-tabs nav-tabs-info nav-justified">
                         <li class="nav-item"><a class="nav-link active"  href="#tab_material_list"   role="tab" data-toggle="tab" aria-expanded="true"><i class="fa fa-list-ol"></i> <?php echo $this->lang->line('list'); ?></a> </li>
                        <?php if(has_permission(ADD, 'academic', 'material')){ ?>
                            <?php if(isset($edit)){ ?>
                                 <li  class="nav-item"><a  class="nav-link" href="<?php echo site_url('academic/material/add'); ?>"  aria-expanded="false"><i class="fa fa-plus-square-o"></i> <?php echo $this->lang->line('add'); ?></a> </li>                          
                             <?php }else{ ?>
                                 <li  class="nav-item"><a  class="nav-link" href="#tab_add_material"  role="tab"  data-toggle="tab" aria-expanded="false"><i class="fa fa-plus-square-o"></i> <?php echo $this->lang->line('add'); ?></a> </li>                          
                             <?php } ?>
                        <?php } ?>                
                        <?php if(isset($edit)){ ?>
                            <li  class="nav-item"><a class="nav-link"  href="#tab_edit_material"  role="tab"  data-toggle="tab" aria-expanded="false"><i class="fa fa-pencil-square-o"></i> <?php echo $this->lang->line('edit'); ?></a> </li>                          
                        <?php } ?> 
                            ...
                            <li class="li-class-list">
                                ...
                                <?php $guardian_access_data = get_guardian_access_data('class'); ?>
                                 ...
                                 <?php }else{  ?> 
                                    <select  class="form-control single-select" onchange="get_material_list_by_class(this.value);">
                    ...
                    <div class="tab-content">
                        <div  class="container tab-pane <?php if(isset($list)){ echo 'active'; }?>" id="tab_material_list" >
                            <div class="x_content">
                        ...
                        <div  class="container tab-pane <?php if(isset($add)){ echo 'active'; }?>" id="tab_add_material">
                            <div class="x_content"> 
                               ...
                               <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <div class="btn btn-default btn-file">
                                            ...
                                            <input  class="form-control"  name="material"  id="material" type="file">
                                        </div>
                        ...
                        <?php if(isset($edit)){ ?>
                        <div class="container tab-pane active" id="tab_edit_material">
                            <div class="x_content"> 
                               <?php echo form_open_multipart(site_url('academic/material/edit/'.$material->id), array('name' => 'edit', 'id' => 'edit', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control"  name="title"  id="title" value="<?php echo isset($material->title) ?  $material->title : ''; ?>" placeholder="<?php echo $this->lang->line('title'); ?>" required="required" type="text" autocomplete="off">
                                        <div class="help-block"><?php echo form_error('title'); ?></div>
                                    </div>
                                </div>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        ...
                                        <div class="btn btn-default btn-file">
                                            <i class="fa fa-paperclip"></i> <?php echo $this->lang->line('upload'); ?>
                                            <input  class="form-control"  name="material"  id="edit_material" type="file">
                                        </div>
                                        <div class="text-info"><?php echo $this->lang->line('valid_file_format_doc'); ?></div>
                                        <div class="help-block"><?php echo form_error('material'); ?></div>
                                    </div>
                                ...
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="description"><?php echo $this->lang->line('description'); ?></label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <textarea  class="form-control"  name="description"  id="edit_description" placeholder="<?php echo $this->lang->line('description'); ?>"><?php echo isset($material->description) ?  $material->description : ''; ?></textarea>
                                        <div class="help-block"><?php echo form_error('description'); ?></div>
                                    </div>
                                </div>

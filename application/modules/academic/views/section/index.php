              ...
              <div class="card-body"> 
                <ul class="nav nav-tabs nav-tabs-info nav-justified">
                        ...
                        <?php if(has_permission(ADD, 'academic', 'section')){ ?>
                            <?php if(isset($edit)){ ?>
                                 <li  class="nav-item"><a  class="nav-link" href="<?php echo site_url('academic/section/add'); ?>"  aria-expanded="false"><i class="fa fa-plus-square-o"></i> <?php echo $this->lang->line('add'); ?></a> </li>                          
                             <?php }else{ ?>
                        ...
                        <li class="li-class-list">
                           ...
                           <?php }else{  ?> 
                                <select  class="form-control single-select" onchange="get_section_by_class(this.value);">
                    ...
                    <div class="tab-content">
                        <div  class="container tab-pane <?php if(isset($list)){ echo 'active'; }?>" id="tab_section_list" >
                            <div class="x_content">
                        ...
                        <div  class="container tab-pane <?php if(isset($add)){ echo 'active'; }?>" id="tab_add_section">
                            <div class="x_content"> 
                               <?php echo form_open(site_url('academic/section/add'), array('name' => 'add', 'id' => 'add', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select  class="form-control select2"  name="class_id"  id="add_class_id" required="required" >
                            ...
                            <div class="x_content"> 
                               <?php echo form_open(site_url('academic/section/edit/'.$section->id), array('name' => 'edit', 'id' => 'edit', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="note"><?php echo $this->lang->line('note'); ?></label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <textarea  class="form-control"  name="note"  id="note" placeholder="<?php echo $this->lang->line('note'); ?>"><?php echo isset($section->note) ?  $section->note : ''; ?></textarea>
                                        <div class="help-block"><?php echo form_error('note'); ?></div>
                                    </div>
                                </div>

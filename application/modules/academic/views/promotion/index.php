                ...
                <div class="row">                    
                    ...
                    <div class="col-md-2 col-sm-2 col-xs-12">
                        <div class="item form-group"> 
                            ...
                            <select  class="form-control single-select" name="current_session_id" id="current_session_id"  required="required">
                    ...
                    <div class="col-md-2 col-sm-2 col-xs-12">
                        <div class="item form-group"> 
                            ...
                            <select  class="form-control single-select" name="next_session_id" id="next_session_id"  required="required" >
                                <option value="">--<?php echo $this->lang->line('select'); ?>--</option>
                    ...
                    <div class="col-md-2 col-sm-2 col-xs-12">
                        <div class="item form-group"> 
                            ...
                            <select  class="form-control single-select" name="current_class_id" id="current_class_id"  required="required" >
                                <option value="">--<?php echo $this->lang->line('select'); ?>--</option>
                    ...
                    <div class="col-md-2 col-sm-2 col-xs-12">
                        <div class="item form-group"> 
                            ...
                            <select  class="form-control single-select" name="next_class_id" id="next_class_id"  required="required" >
                                <option value="">--<?php echo $this->lang->line('select'); ?>--</option>
                                <?php if(isset($classes) && !empty($classes)) { ?>
                                    <?php foreach ($classes as $obj) { ?>
                        ...
                        if (isset($students) && !empty($students)) {
                            ...
                            <?php  $position = get_position_in_class($school_id, $academic_year_id, $current_class_id, $obj->id); ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <select  class="form-control single-select" name="promotion_class_id[<?php echo $obj->id; ?>]"  required="required">                                
                                    ...
                                    <td>
                                        <input type="number" value="<?php if(isset($enroll)){ echo $enroll->roll_no;} ?>"  name="roll_no[<?php echo $obj->id; ?>]"  class="form-control small-field" required="required"  autocomplete="off"/>
                                    </td>
                                </tr>
                            <?php } ?>
                        <?php }else{ ?>

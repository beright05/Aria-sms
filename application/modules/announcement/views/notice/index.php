           ...
           <div class="card">
              <div class="card-body"> 
                <ul class="nav nav-tabs nav-tabs-info nav-justified">
                         <li class="nav-item"><a class="nav-link active" href="#tab_notice_list"   role="tab" data-toggle="tab" aria-expanded="true"><i class="fa fa-list-ol"></i> <?php echo $this->lang->line('list'); ?></a> </li>
                        <?php if(has_permission(ADD, 'announcement', 'notice')){ ?>
                            <?php if(isset($edit)){ ?>
                                 <li  class="nav-item"><a class="nav-link" href="<?php echo site_url('announcement/notice/add'); ?>"  aria-expanded="false"><i class="fa fa-plus-square-o"></i> <?php echo $this->lang->line('add'); ?></a> </li>                          
                             <?php }else{ ?>
                                 <li  class="nav-item"><a class="nav-link" href="#tab_add_notice"  role="tab"  data-toggle="tab" aria-expanded="false"><i class="fa fa-plus-square-o"></i> <?php echo $this->lang->line('add'); ?></a> </li>                          
                             <?php } ?>
                        <?php } ?>
                        <?php if(isset($edit)){ ?>
                            <li  class="nav-item"><a class="nav-link" href="#tab_edit_notice"  role="tab"  data-toggle="tab" aria-expanded="false"><i class="fa fa-pencil-square-o"></i> <?php echo $this->lang->line('edit'); ?></a> </li>                          
                        <?php } ?>  
                            
                        <li class="li-class-list">
                        <?php if($this->session->userdata('role_id') == SUPER_ADMIN){  ?>                                 
                            <select  class="form-control single-select" onchange="get_notice_by_school(this.value);">
                    ...
                    <div class="tab-content">
                        <div  class="container tab-pane <?php if(isset($list)){ echo 'active'; }?>" id="tab_notice_list" >
                            <div class="x_content">
                        ...
                        <div  class="container tab-pane <?php if(isset($add)){ echo 'active'; }?>" id="tab_add_notice">
                            <div class="x_content"> 
                               <?php echo form_open(site_url('announcement/notice/add'), array('name' => 'add', 'id' => 'add', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <textarea  class="form-control"  name="notice"  id="add_notice" required="required" placeholder="<?php echo $this->lang->line('notice'); ?>"><?php echo isset($post['notice']) ?  $post['notice'] : ''; ?></textarea>
                        ...
                        <?php if(isset($edit)){ ?>
                        <div class="container tab-pane active" id="tab_edit_notice">
                            <div class="x_content">
                               ...
                               <?php echo form_open(site_url('announcement/notice/edit/'.$notice->id), array('name' => 'edit', 'id' => 'edit', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control"  name="title"  id="title" value="<?php echo isset($notice->title) ?  $notice->title : ''; ?>" placeholder="<?php echo $this->lang->line('title'); ?>" required="required" type="text" autocomplete="off">
                                        <div class="help-block"><?php echo form_error('title'); ?></div>
                                    </div>
                                </div>
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control"  name="date"  id="edit_date" value="<?php echo isset($notice->date) ?  $notice->date : ''; ?>" placeholder="<?php echo $this->lang->line('date'); ?>" required="required" type="text" autocomplete="off">
                                        <div class="help-block"><?php echo form_error('date'); ?></div>
                                    </div>
                                </div>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select  class="form-control single-select"  name="role_id"  id="edit_role_id" required="required">
                                            <option value="">--<?php echo $this->lang->line('select'); ?>--</option> 
                                ...
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="notice"><?php echo $this->lang->line('notice'); ?> <span class="required">*</span></label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <textarea  class="form-control"  name="notice"  id="edit_notice" required="required" placeholder="<?php echo $this->lang->line('notice'); ?>"><?php echo isset($notice->notice) ?  $notice->notice : ''; ?></textarea>
                                        <div class="help-block"><?php echo form_error('notice'); ?></div>
                                    </div>
                                </div>

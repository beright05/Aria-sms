                ...
                <div class="row">
                    ...
                    <div class="col-md-3 col-sm-3 col-xs-12">
                        <div class="item form-group"> 
                            ...
                            <select  class="form-control single-select" name="section_id" id="section_id" required="required" onchange="get_student_by_section(this.value, '');">                                
                                <option value="">--<?php echo $this->lang->line('select'); ?>--</option>
                            </select>
                    ...
                    <div class="col-md-3 col-sm-3 col-xs-12">
                        <div class="item form-group"> 
                            ...
                            <select  class="form-control single-select"  name="student_id"  id="student_id" required="required">
                                <option value="">--<?php echo $this->lang->line('select'); ?>--</option> 
                            </select>
           ...
           <div class="card">
              <div class="card-body"> 
                <ul class="nav nav-tabs nav-tabs-info nav-justified">                
                        <li  class="nav-item"><a class="nav-link active" href="#tab_student_list" role="tab" data-toggle="tab" aria-expanded="false"><i class="fa fa fa-users"></i> <?php echo $this->lang->line('student_list'); ?></a></li>                          
                    </ul>
                    <br/>
                    <div class="tab-content">
                        <div  class="container tab-pane active" id="tab_student_list">
                            <div class="x_content">

                    ...
                    <tbody id="fn_result">                          
                            ...
                            <?php  $result = get_exam_final_result($school_id, $obj->id, $academic_year_id,  $class_id, $section_id ); ?>
                                <tr>
                                    ...
                                    <td>
                                        <input class="form-control " type="text" name="total_obtain_mark[<?php echo $obj->id; ?>]" value="<?php echo $obtain_total_mark; ?>" style="width: 60px;"  autocomplete="off"/>
                                    </td>
                                    <td><?php echo $grade_point; ?></td>                                    
                                    <td>
                                        <input class="form-control " type="text" name="avg_grade_point[<?php echo $obj->id; ?>]" value="<?php echo $total_grade_point > 0 ? number_format($total_grade_point/$total_exam,2) : ''; ?>" style="width: 60px;"  autocomplete="off"/>
                                    </td>  
                                    <td>
                                        <select class="form-control" name="grade_id[<?php echo $obj->id; ?>]"  required="required">                                
                                            <option value="">--<?php echo $this->lang->line('select'); ?>--</option>

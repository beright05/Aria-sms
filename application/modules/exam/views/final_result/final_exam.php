                    ...
                    <tbody id="fn_result">   
                            ...
                            <?php  $result = get_exam_final_result($school_id, $obj->id, $academic_year_id,  $class_id, $section_id ); ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input class="form-control " type="text" name="avg_grade_point[<?php echo $obj->id; ?>]" value="<?php echo $total_grade_point; ?>" style="width: 60px;"  autocomplete="off"/>
                                    </td>  
                                    <td>
                                    ...
                                    <td><input type="text" value="<?php if(isset($result) && $result->remark != ''){ echo $result->remark; }else{ echo $remark; } ?>"  name="remark[<?php echo $obj->id; ?>]" class="form-control"  autocomplete="off"/></td>
                                </tr>
                            <?php } ?>                       
                    </tbody>
                </table>

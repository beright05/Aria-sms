                        ...
                        if (isset($students) && !empty($students)) {
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        <input class="form-control " type="text" name="avg_grade_point[<?php echo $obj->id; ?>]" value="<?php echo @number_format($mark->total_point/$mark->total_subject,2); ?>" style="width: 60px;"  autocomplete="off"/>
                                    </td>  
                                    <td>

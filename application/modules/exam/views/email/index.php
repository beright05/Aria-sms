           ...
           <div class="card">
              <div class="card-body"> 
                <ul class="nav nav-tabs nav-tabs-info nav-justified">
                         <li class="nav-item"><a  class="nav-link active" href="#tab_send_email_list"   role="tab" data-toggle="tab" aria-expanded="true"><i class="fa fa-list-ol"></i> <?php echo $this->lang->line('list'); ?></a> </li>
                        <li class="nav-item <?php if(isset($add)){ echo 'active'; }?>"><a class="nav-link" href="#tab_send_email"   role="tab" data-toggle="tab" aria-expanded="true"><i class="fa fa-location-arrow"></i> <?php echo $this->lang->line('send_email'); ?></a> </li>
                        <li class="li-class-list">
                        <?php if($this->session->userdata('role_id') == SUPER_ADMIN){  ?>                                 
                             <select  class="form-control single-select" onchange="get_email_by_school(this.value);">
                    ...
                    <br/>
                     ...
                     <div class="tab-content"> 
                         ...
                         <div  class="container tab-pane <?php if(isset($list)){ echo 'active'; }?>" id="tab_send_email_list" >
                            <div class="x_content">
                        ...
                        <div  class="container tab-pane <?php if(isset($add)){ echo 'active'; }?>" id="tab_send_email">
                            <div class="x_content"> 
                               <?php echo form_open_multipart(site_url('exam/mail/send'), array('name' => 'sendemail', 'id' => 'sendemail', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="item form-group"> 
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select  class="form-control single-select"  name="exam_id"  id="exam_id" required="required">
                                ...
                                <div class="form-group"> 
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control"  name="subject"  id="subject" value="" placeholder="<?php echo $this->lang->line('subject'); ?>" required="required" type="text"  autocomplete="off">

                ...
                <div class="row">
                    ...
                    <div class="col-md-2 col-sm-2 col-xs-12">
                        <div class="item form-group"> 
                            ...
                            <select  class="form-control single-select" name="class_id" id="class_id"  required="required" onchange="get_section_by_class(this.value,'');">
                                <option value="">--<?php echo $this->lang->line('select'); ?>--</option>
                    ...
                    <div class="col-md-2 col-sm-2 col-xs-12">
                        <div class="item form-group"> 
                            ...
                            <select  class="form-control single-select" name="section_id" id="section_id" required="required">                                
                                <option value="">--<?php echo $this->lang->line('select'); ?>--</option>
                            </select>
                            ...
                            <?php  $result = get_exam_result($obj->id, $academic_year_id, $exam_id, $class_id, $section_id ); ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <input type="number" value="<?php if(isset($mark) && $mark->exam_mark > 0 ){ echo $mark->exam_mark; }else{ echo '';} ?>"  name="exam_total_mark[<?php echo $obj->id; ?>]" class="form-control small-field" required="required" size="4"  autocomplete="off"/>
                                    </td>
                                    <td>
                                        <input type="number"  readonly="readonly" value="<?php if(isset($mark) && $mark->obtain_mark > 0 ){ echo $mark->obtain_mark; }else{ echo ''; } ?>"  name="obtain_total_mark[<?php echo $obj->id; ?>]" class="form-control small-field" required="required" size="4"  autocomplete="off"/>
                                    </td>
                                    <td>
                                        <input type="number" readonly="readonly" value="<?php if(isset($result) && $result->avg_grade_point > 0 ){ echo $result->avg_grade_point; }else{ echo @round($mark->total_point/$mark->total_subject,2); } ?>"  name="avg_grade_point[<?php echo $obj->id; ?>]" class="form-control small-field" required="required" size="4"  autocomplete="off"/>
                                    </td>
                                    <td><input type="text" value="<?php if(isset($result) && $result->remark != ''){ echo $result->remark; } ?>"  name="remark[<?php echo $obj->id; ?>]" class="form-control"  autocomplete="off"/></td>
                                </tr>
                            <?php } ?>
                        <?php }else{ ?>
                                <tr>

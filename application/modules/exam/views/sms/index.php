           ...
           <div class="card">
              <div class="card-body"> 
                <ul class="nav nav-tabs nav-tabs-info nav-justified">
                         <li class="nav-item"><a class="nav-link active" href="#tab_send_sms_list"   role="tab" data-toggle="tab" aria-expanded="true"><i class="fa fa-list-ol"></i> <?php echo $this->lang->line('list'); ?></a> </li>
                        <li class="nav-item<?php if(isset($add)){ echo 'active'; }?>"><a class="nav-link" href="#tab_send_sms"   role="tab" data-toggle="tab" aria-expanded="true"><i class="fa fa-location-arrow"></i> <?php echo $this->lang->line('send_sms'); ?></a> </li>
                        
                        <li class="li-class-list">
                        <?php if($this->session->userdata('role_id') == SUPER_ADMIN){  ?>                                 
                             <select  class="form-control single-select" onchange="get_sms_by_school(this.value);">
                    ...
                    <div class="tab-content"> 
                            ...
                            <div  class="container tab-pane <?php if(isset($list)){ echo 'active'; }?>" id="tab_send_sms_list" >
                            <div class="x_content">
                        ...
                        <div  class="container tab-pane <?php if(isset($add)){ echo 'active'; }?>" id="tab_send_sms">
                            <div class="x_content"> 

           ...
           <div class="card">
              <div class="card-body"> 
                <ul class="nav nav-tabs nav-tabs-info nav-justified">
                         <li class="nav-item"><a class="nav-link active" href="#tab_email_list"   role="tab" data-toggle="tab" aria-expanded="true"><i class="fa fa-list-ol"></i> <?php echo $this->lang->line('list'); ?></a> </li>
                         <li  class="nav-item"><a class="nav-link" href="#tab_add_email"  role="tab"  data-toggle="tab" aria-expanded="false"><i class="fa fa-plus-square-o"></i> <?php echo $this->lang->line('send_email'); ?></a> </li>                          
                        
                        <li class="li-class-list">
                            <?php if($this->session->userdata('role_id') == SUPER_ADMIN){  ?>                                  
                                <select  class="form-control auto-width" name="school_id_filter" id="school_id_filter" onchange="get_email_by_school(this.value)">
                    ...
                    <div class="tab-content">
                        ...
                        <div  class="container tab-pane <?php if(isset($list)){ echo 'active'; }?>" id="tab_email_list" >
                            <div class="x_content">
                        ...
                        <div  class="container tab-pane <?php if(isset($add)){ echo 'active'; }?>" id="tab_add_email">
                            <div class="x_content"> 
                               <?php echo form_open_multipart(site_url('attendance/absentemail/add'), array('name' => 'add', 'id' => 'add', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="item form-group"> 
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select  class="form-control single-select"  name="role_id"  id="role_id" required="required" onchange="get_user_by_role(this.value, '');">
                                ...
                                <div class="item form-group display"> 
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select  class="form-control single-select"  name="class_id"  id="class_id"  onchange="get_user('', this.value,'');">
                                            <option value="">--<?php echo $this->lang->line('select'); ?>--</option>  
                                ...
                                <div class="item form-group">  
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select  class="form-control single-select"  name="receiver_id"  id="receiver_id" required="required" >
                                            <option value="">--<?php echo $this->lang->line('select'); ?>--</option>                                                                                         
                                        </select>
                                ...
                                <div class="item form-group">  
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select  class="form-control single-select"  name="template"  id="fn_template" onchange="get_email_template_by_id(this.value)">
                                ...
                                <div class="form-group"> 
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control"  name="absent_date"  id="absent_date" value="" placeholder="<?php echo $this->lang->line('absent_date'); ?>" required="required" type="text" autocomplete="off">
                                ...
                                <div class="form-group"> 
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control"  name="subject"  id="subject" value="" placeholder="<?php echo $this->lang->line('subject'); ?>" required="required" type="text">

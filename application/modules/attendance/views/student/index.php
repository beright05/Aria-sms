                ...
                <div class="row">
                    ...
                    <div class="col-md-2 col-sm-2 col-xs-12">
                        <div class="item form-group">  
                            ...
                            <input  class="form-control"  name="date"  id="date" value="<?php if(isset($date)){ echo $date;} ?>" placeholder="<?php echo $this->lang->line('date'); ?>" required="required" type="text" autocomplete="off">
